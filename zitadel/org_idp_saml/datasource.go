...
func GetDatasource() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			idp_saml.NameIdFormatVar:                  idp_saml.NameIdFormatDatasourceField,
			idp_saml.TransientMappingAttributeNameVar: idp_saml.TransientMappingAttributeNameDatasourceField,
			idp_saml.FederatedLogoutEnabledVar:        idp_saml.FederatedLogoutEnabledDatasourceField,
			idp_saml.SignatureAlgorithmVar:            idp_saml.SignatureAlgorithmDatasourceField,
