...
func TestAccIdpGitlabSelfHostedDatasource(t *testing.T) {
	frame := test_utils.NewInstanceTestFrame(t, "zitadel_idp_gitlab_self_hosted")
...
data "zitadel_idp_gitlab_self_hosted" "default" {
  id = zitadel_idp_gitlab_self_hosted.default.id
}`
