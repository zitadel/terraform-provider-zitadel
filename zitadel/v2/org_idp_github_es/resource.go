...
func GetResource() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			idp_github_es.AuthorizationEndpointVar: idp_github_es.AuthorizationEndpointResourceField,
			idp_github_es.TokenEndpointVar:         idp_github_es.TokenEndpointResourceField,
			idp_github_es.UserEndpointVar:          idp_github_es.UserEndpointResourceField,
		},
		ReadContext:   read,
