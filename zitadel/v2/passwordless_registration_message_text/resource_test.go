package passwordless_registration_message_text_test
...
func TestAccZITADELPasswordlessRegistrationMessageText(t *testing.T) {
...
func checkRemoteProperty(frame *test_utils.OrgTestFrame, lang string) func(interface{}) resource.TestCheckFunc {
	return func(expect interface{}) resource.TestCheckFunc {
		return func(state *terraform.State) error {
			remoteResource, err := frame.GetCustomPasswordlessRegistrationMessageText(frame, &management.GetCustomPasswordlessRegistrationMessageTextRequest{Language: lang})
			if err != nil {
				return err
			}
