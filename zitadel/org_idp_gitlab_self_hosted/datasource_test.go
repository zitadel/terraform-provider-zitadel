...
func TestAccOrgIdpGitlabSelfHostedDatasource(t *testing.T) {
	frame := test_utils.NewOrgTestFrame(t, "zitadel_org_idp_gitlab_self_hosted")
...
data "zitadel_org_idp_gitlab_self_hosted" "default" {
  org_id = data.zitadel_org.default.id
  id     = zitadel_org_idp_gitlab_self_hosted.default.id
}`
