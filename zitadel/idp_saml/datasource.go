...
func GetDatasource() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			NameIdFormatVar:                  NameIdFormatDatasourceField,
			TransientMappingAttributeNameVar: TransientMappingAttributeNameDatasourceField,
			FederatedLogoutEnabledVar:        FederatedLogoutEnabledDatasourceField,
			SignatureAlgorithmVar:            SignatureAlgorithmDatasourceField,
